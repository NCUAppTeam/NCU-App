...
function CosmeticProductScreen({ navigation }) {
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(5, 0).then((res) => {
      // console.warn('h');
      setSellProduct(res);
    }).catch((err) => {
      throw err;
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(5, 1).then((res) => {
      // console.warn('h');
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(5, 2).then((res) => {
      // console.warn('h');
      setRentProduct(res);
    }).catch((err) => {
      throw err;
...
export default CosmeticProductScreen;
