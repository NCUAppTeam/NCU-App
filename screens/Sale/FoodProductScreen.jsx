...
function FoodProductScreen({ navigation }) {
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(3, 0).then((res) => {
      // console.warn('h');
      setSellProduct(res);
    }).catch((err) => {
      throw err;
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(3, 1).then((res) => {
      // console.warn('h');
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(3, 2).then((res) => {
      // console.warn('h');
      setRentProduct(res);
    }).catch((err) => {
      throw err;
...
export default FoodProductScreen;
