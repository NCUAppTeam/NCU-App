...
function HomeProductScreen({ navigation }) {
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(2, 0).then((res) => {
      // console.warn('h');
      setSellProduct(res);
    }).catch((err) => {
      throw err;
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(2, 1).then((res) => {
      // console.warn('h');
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(2, 2).then((res) => {
      // console.warn('h');
      setRentProduct(res);
    }).catch((err) => {
      throw err;
