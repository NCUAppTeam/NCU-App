...
function OtherProductScreen({ navigation }) {
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(7, 0).then((res) => {
      // console.warn('h');
      setSellProduct(res);
    }).catch((err) => {
      throw err;
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(7, 1).then((res) => {
      // console.warn('h');
  ...
  useEffect(() => {
    SalesController.getItembyTagandType(7, 2).then((res) => {
      // console.warn('h');
      setRentProduct(res);
    }).catch((err) => {
      throw err;
...
export default OtherProductScreen;
